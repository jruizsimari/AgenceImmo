    ...
    <div class="container">
        <div class="bg-light p-5 mb-5 text-center">
            <form action="" method="get" class="container d-flex gap-2">
                ...
                <input type="number" placeholder="Nombre pièces min" class="form-control" name="rooms" value="{{ $input['rooms'] ?? '' }}">
        ...
        <div class="row">
            ...
            @empty
                <div class="col">
                    Aucun bien ne correspond à votre recherche. Merci de changer vos critères de recherche.
                </div>
            @endforelse
        </div>
